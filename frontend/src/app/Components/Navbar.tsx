  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        {/* Desktop Menu */}
        <div
          className="hidden md:flex space-x-8 text-sm lg:text-base font-medium font-[var(--font-inter-tight)]"
        ...
        <div className="hidden md:block">
          <Link
            ...
            className="px-4 py-2 lg:px-6 lg:py-3 border border-pink-500 text-pink-400 hover:text-white rounded-full shadow-lg font-semibold transition font-[var(--font-cossette-titre)]"
          >
            Contact Us
          </Link>
        </div>
